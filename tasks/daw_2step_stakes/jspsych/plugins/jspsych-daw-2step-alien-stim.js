...
* Wouter Kool
*
* plugin for displaying an instruction screen about the reward choices in the Daw 2-step task
*
**/

(function($) {
	jsPsych["daw-2step-alien-stim"] = (function() {
		...
		var display_stimuli = function(stage){
			...
			if (stage==1) { // choice stage
				...
				$('#jspsych-daw-2step-bottom-stim-'+position).css('background-image', 'url(img/'+state_name+'_stim_1.png)');
				$('#jspsych-daw-2step-bottom-stim-'+other_position).css('background-image', 'url(img/'+state_name+'_stim_2_deact.png)');
			...
			if (stage==3) { // reward
				...
				if (win==0) {
					...
					$('#jspsych-daw-2step-bottom-stim-'+position).css('background-image', 'url(img/'+state_name+'_stim_1_sad.png)');
				} else {
					if (show_points == 0) {
						$('#jspsych-daw-2step-middle-stim-'+position).css('background-image', 'url(img/treasure.png)');
						$('#jspsych-daw-2step-bottom-stim-'+position).css('background-image', 'url(img/'+state_name+'_stim_1_happy.png)');
					} else {
